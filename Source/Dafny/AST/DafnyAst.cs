...
namespace Microsoft.Dafny {
  ...
  */
  ...
  public class ParensExpression : ConcreteSyntaxExpression {
    public readonly Expression E;
    public readonly IToken CloseParenthesisTok;
    public ParensExpression(IToken tok, IToken closeParenTok, Expression e)
      : base(tok) {
      E = e;
      CloseParenthesisTok = closeParenTok;
    }
  }
  ...
  public class ApplySuffix : SuffixExpr {
    ...
    public readonly ActualBindings Bindings;
    public List<Expression> Args => Bindings.Arguments;
    public IToken CloseParanthesisToken;
    ...
    public ApplySuffix(IToken tok, IToken/*?*/ atLabel, Expression lhs, List<ActualBinding> args, IToken closeParanthesisToken)
      : base(tok, lhs) {
      Contract.Requires(tok != null);
      Contract.Requires(lhs != null);
      Contract.Requires(cce.NonNullElements(args));
